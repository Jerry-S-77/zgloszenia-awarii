...
6. **Zadania** (`/zadania`, technik i admin w pasku nawigacji; kierownik ma dostęp z linku, bez pozycji w pasku) — zgłoszenia do przyjęcia, przypisane do zalogowanego technika oraz przeglądy opóźnione i w ciągu 14 dni.
